local STRICT_TYPES = false -- [disabled] assert on parameter and property type mismatch
local STRICT_API_ACCESS = false -- [disabled] lock down the API table to prevent writes & empty reads
